---
description: >
  Use when architecting frontend features, reviewing component structure,
  optimizing TypeScript, designing API integrations, evaluating framework
  patterns, refactoring legacy code, or implementing features requiring
